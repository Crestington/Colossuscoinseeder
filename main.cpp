...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Colossuscoin-seeder\n"
...
static const string mainnet_seeds[] = {"dnsseed.colossuscoin.info"};
static const string testnet_seeds[] = {"testnet-seed.colossuscoin.info"};
